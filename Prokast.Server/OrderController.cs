...
namespace Prokast.Server.Controllers
{
    ...
    public class OrderController: ControllerBase
    {
        ...
        /// <summary>
        /// Funkcja która pozwala rejestrować nowe zamówienie oraz kupca w przypadku gdy składa zamówienie po raz pierwszy
        /// </summary>
        ...
        #endregion
        /// <summary>
        /// Funkcja służaca do dodania trackingID do danego zamówienia
        /// </summary>
        /// <param name="clientID"></param>
        ...
        /// <summary>
        /// Funkcja służaca do edycji statusu danego zamówienia
        /// </summary>
        /// <param name="clientID"></param>
        /// <param name="orderID"></param>
        ...
        /// <summary>
        /// Funkcja służaca do edycji statusu płatności danego zamówienia
        /// </summary>
        /// <param name="clientID"></param>
        /// <param name="orderID"></param>
        ...
        /// <summary>
        /// Funkcja służaca do edycji danych wybranego zamówienia
        /// </summary>
        /// <param name="clientID"></param>
        /// <param name="orderID"></param>
        ...
        /// <summary>
        /// Funkcja służaca do edycji danych kupca
        /// </summary>
        /// <param name="clientID"></param>
